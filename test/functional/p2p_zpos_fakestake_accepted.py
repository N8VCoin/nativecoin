#!/usr/bin/env python3
# Copyright (c) 2019 The NativeCoin Core developers
...
from fake_stake.base_test import nativecoin_FakeStakeTest
from time import sleep

class zPoSFakeStakeAccepted(nativecoin_FakeStakeTest):
    ...
    def set_test_params(self):
        ...
        self.num_nodes = 1
        self.extra_args = [['-staking=1', '-debug=net', '-zdogecstake']] * self.num_nodes
