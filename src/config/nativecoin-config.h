/* src/config/nativecoin-config.h.  Generated from nativecoin-config.h.in by configure.  */
/* src/config/nativecoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.n8vcoin.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "NativeCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "NativeCoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "NativeCoin"
