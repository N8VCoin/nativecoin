...
#ifndef nativecoin_zNATIVETRACKER_H
#define nativecoin_zNATIVETRACKER_H
...
public:
    CzNATIVETracker(std::string strWalletFile);
    ~CzNATIVETracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzNATIVEWallet* zNATIVEWallet = NULL);
...
#endif //nativecoin_zNATIVETRACKER_H
