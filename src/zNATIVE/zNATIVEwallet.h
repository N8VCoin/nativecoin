...
#ifndef nativecoin_zNATIVEWALLET_H
#define nativecoin_zNATIVEWALLET_H
...
public:
    CzNATIVEWallet(std::string strWalletFile);
    ...
    void GenerateDeterministiczNATIVE(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedTozNATIVE(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //nativecoin_zNATIVEWALLET_H
