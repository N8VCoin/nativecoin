...
/** Utility functions used by the nativecoin Qt UI.
 */
namespace GUIUtil
{
...
// Render nativecoin addresses in monospace font
...
// Parse "nativecoin:" URI into recipient object, return true on successful parsing
