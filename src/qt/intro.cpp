...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        intro.setWindowIcon(QIcon(QICON_PATH_INTROWINDOWICON));
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("NativeCoin Core"),
     ...
     * override -datadir in the nativecoin.conf file in the default data directory
     * (to be consistent with nativecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
