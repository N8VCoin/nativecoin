...
public:
    ...
    void setzNATIVEControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzNATIVE_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzNATIVE_clicked();
    void on_pushButtonzNATIVEControl_clicked();
