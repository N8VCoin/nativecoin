...
{   
    ...
    labelOverviewHeaderLeft->setMaximumSize(QSize(16777215, 65));
    ...
    QSpacerItem* horizontalSpacer_3 = new QSpacerItem(40, 10, QSizePolicy::Expanding, QSizePolicy::Minimum);
    ...
    labelOverviewHeaderRight->setMinimumSize(QSize(464, 40));
    labelOverviewHeaderRight->setMaximumSize(QSize(16777215, 65));
    ...
    exportButton->setIcon(QIcon(QICON_PATH_EXPORTDATA));
#endif
