...
const struct {
    ...
    {"cmd-request", QICON_PATH_CONSOLEINPUT},
    {"cmd-reply",   QICON_PATH_CONSOLEOUTPUT},
    {"cmd-error",   QICON_PATH_CONSOLEERROR},
    {"misc",        QICON_PATH_CONSOLEMISC},
    {NULL,          NULL}
};
                                          ...
                                          banTableContextMenu(0)
{
...
#ifndef Q_OS_MAC
    ui->openDebugLogfileButton->setIcon(QIcon(QICON_PATH_DEBUGLOG));
#endif
    ...
    std::string strzNATIVEPathCustom = GetArg("-zNATIVEbackuppath", "");
    ...
    if(!strzNATIVEPathCustom.empty()) {
        ui->wallet_customzNATIVEbackuppath->setText(QString::fromStdString(strzNATIVEPathCustom));
        ui->wallet_customzNATIVEbackuppath_label->setVisible(true);
        ui->wallet_customzNATIVEbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzNATIVEPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::setClientModel(ClientModel* model)
{
    ...
    if (model && clientModel->getPeerTableModel() && clientModel->getBanTableModel()) {
        ...
        // ADD copy IP, copy all (line), copy peer info
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the NativeCoin RPC console.") + "<br>" +
