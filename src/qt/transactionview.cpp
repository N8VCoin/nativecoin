                                                    ...
                                                    transactionView(0)
{
    ...
    watchOnlyWidget->addItem(QIcon(QICON_PATH_TXWATCHONLYYES), "", TransactionFilterProxy::WatchOnlyFilter_Yes);
    watchOnlyWidget->addItem(QIcon(QICON_PATH_TXWATCHONLYNO), "", TransactionFilterProxy::WatchOnlyFilter_No);
 ...
 */
    ...
    typeWidget->addItem(tr("Minted"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint) | TransactionFilterProxy::TYPE(TransactionRecord::StakezNATIVE));
    typeWidget->addItem(tr("Masternode Reward"), TransactionFilterProxy::TYPE(TransactionRecord::MNReward));
    typeWidget->addItem(tr("Received N8V from zNATIVE"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zNATIVE"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zNATIVE));
