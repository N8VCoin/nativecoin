...
bool MultisigDialog::createMultisigTransaction(vector<CTxIn> vUserIn, vector<CTxOut> vUserOut, string& feeStringRet, string& errorRet)
{
    try{
        ...
        if(totalIn < totalOut){
            throw runtime_error("Not enough N8V provided as input to complete transaction (including fee).");
        }
        ...
        if(tx.vout.at(changeIndex).nValue > fee){
            ...
            throw runtime_error("Not enough N8V provided to cover fee");
        }
...
void MultisigDialog::on_addAddressButton_clicked()
{
    ...
    QIcon icon3;
    icon3.addFile(QStringLiteral(QICON_PATH_ADDRESSBOOK), QSize(), QIcon::Normal, QIcon::Off);
    ...
    QIcon icon4;
    icon4.addFile(QStringLiteral(QICON_PATH_ADDRESSPASTE), QSize(), QIcon::Normal, QIcon::Off);
    ...
    QIcon icon5;
    icon5.addFile(QStringLiteral(QICON_PATH_ADDRESSDELETE), QSize(), QIcon::Normal, QIcon::Off);
...
void MultisigDialog::on_addInputButton_clicked()
{
    ...
    QIcon icon;
    icon.addFile(QStringLiteral(QICON_PATH_INPUTDELETE), QSize(), QIcon::Normal, QIcon::Off);
...
void MultisigDialog::on_addDestinationButton_clicked()
{
    ...
    QIcon icon;
    icon.addFile(QStringLiteral(QICON_PATH_DESTINATIONDELETE), QSize(), QIcon::Normal, QIcon::Off);
...
void MultisigDialog::on_addPrivKeyButton_clicked()
{
    ...
    QIcon icon;
    icon.addFile(QStringLiteral(QICON_PATH_KEYDELETE), QSize(), QIcon::Normal, QIcon::Off);
