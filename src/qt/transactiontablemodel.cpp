...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeMint:
        return tr("N8V Stake");
    case TransactionRecord::StakezNATIVE:
        return tr("zNATIVE Stake");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted N8V to zNATIVE");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zNATIVE");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received N8V from zNATIVE");
    case TransactionRecord::ZerocoinSpend_Change_zNATIVE:
        return tr("Minted Change as zNATIVE from zNATIVE Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zNATIVE to N8V");
...
QVariant TransactionTableModel::txAddressDecoration(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::Generated:
    case TransactionRecord::StakeMint:
        return QIcon(QICON_PATH_STAKEREWARD);
    case TransactionRecord::StakezNATIVE:
    case TransactionRecord::MNReward:
        return QIcon(QICON_PATH_MNREWARD);
    case TransactionRecord::RecvWithObfuscation:
    case TransactionRecord::RecvWithAddress:
    case TransactionRecord::RecvFromOther:
    case TransactionRecord::RecvFromZerocoinSpend:
        return QIcon(QICON_PATH_TXIN);
    case TransactionRecord::SendToAddress:
    case TransactionRecord::SendToOther:
    case TransactionRecord::ZerocoinSpend:
        return QIcon(QICON_PATH_TXOUT);
    default:
        return QIcon(QICON_PATH_TXINOUT);
    }
}
...
QString TransactionTableModel::formatTxToAddress(const TransactionRecord* wtx, bool tooltip) const
{
    ...
    case TransactionRecord::ZerocoinMint:
    case TransactionRecord::ZerocoinSpend_Change_zNATIVE:
        return tr("Anonymous (zNATIVE Transaction)");
    case TransactionRecord::StakezNATIVE:
        return tr("Anonymous (zNATIVE Stake)");
    case TransactionRecord::SendToSelf:
    default:
...
QVariant TransactionTableModel::txStatusDecoration(const TransactionRecord* wtx) const
{
    ...
    case TransactionStatus::Unconfirmed:
        return QIcon(QICON_PATH_TXUNCONFIRMED);
    case TransactionStatus::Confirming:
        switch (wtx->status.depth) {
        case 1:
            return QIcon(QICON_PATH_TXCONFIRMONE);
        case 2:
            return QIcon(QICON_PATH_TXCONFIRMTWO);
        case 3:
            return QIcon(QICON_PATH_TXCONFIRMTHREE);
        case 4:
            return QIcon(QICON_PATH_TXCONFIRMFOUR);
        default:
            return QIcon(QICON_PATH_TXCONFIRMDEFAULT);
        };
    case TransactionStatus::Confirmed:
        return QIcon(QICON_PATH_TXCONFIRMED);
    case TransactionStatus::Conflicted:
        return QIcon(QICON_PATH_TXCONFLICTED);
    case TransactionStatus::Immature: {
        int total = wtx->status.depth + wtx->status.matures_in;
        int part = (wtx->status.depth * 5 / total) + 1;
        return QIcon(QString(QICON_PATH_TXIMMATURE).arg(part));
    }
    case TransactionStatus::MaturesWarning:
    case TransactionStatus::NotAccepted:
        return QIcon(QICON_PATH_TXNOACCEPT);
    default:
        return COLOR_BLACK;
    }
}
...
QVariant TransactionTableModel::txWatchonlyDecoration(const TransactionRecord* wtx) const
{
    if (wtx->involvesWatchAddress)
        return QIcon(QICON_PATH_TXWATCHADDRESS);
    else
        return QVariant();
}
...
QVariant TransactionTableModel::data(const QModelIndex& index, int role) const
{
    ...
    case Qt::ForegroundRole:
        ...
        if (rec->type == TransactionRecord::Generated || rec->type == TransactionRecord::StakeMint ||
                rec->type == TransactionRecord::StakezNATIVE || rec->type == TransactionRecord::MNReward) {
