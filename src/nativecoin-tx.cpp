...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("NativeCoin Core nativecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nativecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nativecoin transaction") + "\n" +
                               "  nativecoin-tx [options] -create [commands]   " + _("Create hex-encoded nativecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nativecoin transaction
