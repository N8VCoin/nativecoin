...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
    ...
    UniValue zNATIVEObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zNATIVEObj.push_back(Pair(to_string(denom), ValueFromAmount(blockindex->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zNATIVEObj.push_back(Pair("total", ValueFromAmount(blockindex->GetZerocoinSupply())));
    result.push_back(Pair("zNATIVEsupply", zNATIVEObj));
...
UniValue getchecksumblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "  \"zNATIVEsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zNATIVE denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zNATIVE denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zNATIVE denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zNATIVE denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zNATIVE denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zNATIVE denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zNATIVE denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zNATIVE denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zNATIVE denominations\n"
            "  }\n"
            "}\n"
...
UniValue getrawmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in nativecoin\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of nativecoin addresses\n"
...
UniValue getaccumulatorwitness(const UniValue& params, bool fHelp)
{
    ...
    if (!GenerateAccumulatorWitness(pubCoin, accumulator, witness, nMintsAdded, strFailReason)) {
        receipt.SetStatus(_(strFailReason.c_str()), zNATIVE_FAILED_ACCUMULATOR_INITIALIZATION);
