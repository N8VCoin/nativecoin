...
/**
 * nativecoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzNATIVEseed(const UniValue& params, bool fHelp);
extern UniValue getzNATIVEseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzNATIVE(const UniValue& params, bool fHelp);
extern UniValue dzNATIVEstate(const UniValue& params, bool fHelp);
