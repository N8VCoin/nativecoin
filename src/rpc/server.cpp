...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop nativecoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "nativecoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* nativecoin features */
    //    {"nativecoin", "masternode", &masternode, true, true, false},
        {"nativecoin", "listmasternodes", &listmasternodes, true, true, false},
        {"nativecoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nativecoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nativecoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"nativecoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"nativecoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"nativecoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nativecoin", "masternodedebug", &masternodedebug, true, true, false},
        {"nativecoin", "startmasternode", &startmasternode, true, true, false},
        {"nativecoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"hidden", "masternodegenkey", &createmasternodekey, true, true, false},
        {"nativecoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nativecoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nativecoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nativecoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nativecoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nativecoin", "mnsync", &mnsync, true, true, false},
        {"nativecoin", "spork", &spork, true, true, false},
        {"nativecoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> nativecoin-cli " + methodname + " " + args + "\n";
}
