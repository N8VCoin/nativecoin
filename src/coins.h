...
/** 
    ...
    ****Note - for nativecoin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of nativecoin coming in to a transaction
