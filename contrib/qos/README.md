...
This means one can have an always-on nativecoind instance running, and another local nativecoind/nativecoin-qt instance which connects to this node and receives blocks from it.
