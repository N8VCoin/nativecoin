NativeCoin Core version *3.2.0* is now available from:  <https://github.com/nativecoin-project/nativecoin/releases>
...
NativeCoin Core v3.2.0 is a **mandatory update** for all block creators, masternodes, and integrated services (exchanges). Old version 4 blocks will be rejected once 95% of a rolling 7 days worth of blocks have signaled the new version 5.
...
A full report provided by NativeCoin developers is available on the [NativeCoin Website](https://pivx.org/fake-stake-official-nativecoin-report/), which includes additional findings, mitigation details, and resources for testing. This type of attack has no risk to users' privacy and does not affect their holdings.
