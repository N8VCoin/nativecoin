...
This mechanism has been integrated into Bitcore-Node-nativecoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/nativecoin-Project/insight-api-nativecoin#web-socket-api](https://github.com/nativecoin-Project/insight-api-nativecoin#web-socket-api) 
* API: [https://github.com/nativecoin-Project/insight-api-nativecoin#swifttx-transactions](https://github.com/nativecoin-Project/insight-api-nativecoin#swifttx-transactions) 
...
By default, the NativeCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the NativeCoin Core daemon:
