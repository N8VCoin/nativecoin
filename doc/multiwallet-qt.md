...
In order to support loading of multiple wallets in nativecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nativecoin.cpp.
...
Changes to nativecoin.cpp
----------------------
nativecoin.cpp is the entry point into nativecoin-qt, and as such, will require some minor modifications to provide hooks for
